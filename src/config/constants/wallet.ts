...
const COINBASE_ICON_URL = '/assets/images/coinbase_icon.png'
const METAMASK_ICON_URL = '/assets/images/metamask_icon.svg'
const WALLETCONNECT_ICON_URL = '/assets/images/wallet_connect_icon.svg'
